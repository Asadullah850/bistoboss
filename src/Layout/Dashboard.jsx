...
import { FaEnvelope, FaThList, FaEnvelopeOpenText, FaAlignJustify } from "react-icons/fa";
        ...
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 w-60 bg-[#D1A054] text-base-content uppercase">
                    ...
                    <li className='text-black'><NavLink to={'/'}><HiHome className='text-xl'></HiHome>User Home</NavLink></li>
